...
public class ContactServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //response.setStatus(HttpServletResponse.SC_NO_CONTENT);
        ...
        String name,email,description,phno,query,c_date;
        ...
        query="insert into contact_detail values('"+c_date+"','"+name+"','"+phno+"','"+email+"','"+description+"')";
       ...
       /* try () { 
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>"+name+"<br>"+email+"<br>"+description+"<br>"+phno+"<br>"+c_date+"</h1>");
            out.println("</body>");
            out.println("</html>");
