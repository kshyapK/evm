<%-- 
    Document   : decoration
    Created on : 14 Apr, 2019, 5:43:15 AM
    Author     : user
--%>
...
<html>
    ...
    <body onload="clearFields();">
            ...
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <ul class="nav navbar-nav" style="float: right;">
                    ...
                    <li><a href="photography.jsp" class="active linkColor">Photography</a></li>
       ...
       <div class="parallax">
        ...
        <section class="bg">
         <div class="wrapper">
            <h3 class="content-title1">"Everything has a place, and everything in its place."</h3>
            <hr style="float:center;width:50%;background-color: #666666;opacity: 0.5">
            <p class="content-title">"A designer knows when he has reached perfection not when there is nothing left to add but when there is nothing left to take away."</p> 
            <br>
            <h3 class="content-title2">PORTFOLIO</h3>
            <hr style="float:center;width:50%;background-color: #666666;opacity: 0.5">   
            <div class="imgholder"> 
               <div class="column">
                   <img src="img/decoration/pexels-photo-1395967.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-949586.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-1128782.jpeg" style="width:100%">
                   
               </div>
               <div class="column">
                   <img src="img/decoration/pexels-photo-265903.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-169192.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-2128339.jpeg" style="width:100%">
                  
               </div>  
               <div class="column">
                   <img src="img/decoration/pexels-photo-931179.jpeg" style="width:100%">
                   <img src="img/decoration/light-bokeh-colors-blur-722680.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-169190.jpeg" style="width:100%">
               </div>
               <div class="column">
                   <img src="img/decoration/pexels-photo-1804684.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-169198.jpeg" style="width:100%">
                   <img src="img/decoration/pexels-photo-169183.jpeg" style="width:100%">
               </div>
             </div>
        </div>
    </section>
           ...
           <div class="row" style="margin-top: 550px" id="contact">
         <form name="myForm"  action="EnquiryHandlerServlet" method="post">
        <div class="container-fluid" id="contact">
            <div class="row bottomDiv2" id="my">
                <div class="col-md-5">
                    <h2 class="contact">Lets make something awesome together..</h2>
