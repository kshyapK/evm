<%-- 
    ...
    Created on : 14 Apr, 2019, 5:44:15 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Dream Events|Accommodation Services</title>
    ...
    <body onload="clearFields();">
       ...
       <div class="parallax">
        <div class="background backgroundAccommodation">
            <h2 class="title">Accommodation</h2>
        
        </div>
        <section class="bg">
         <div class="wrapper">
             <h3 class="content-title1">“We offer a luxurious accommodation services <br> We have a collection of grand hotels that provides a better living experience."</h3>
            <hr style="float:center;width:50%;background-color: #666666;opacity: 0.5">
            <p class="content-title">“There are different varieties of services provided based on different rooms ”</p> 
            <br>
            <h3 class="content-title1">Portfolio</h3>
            <hr style="float:center;width:50%;background-color: #666666;opacity: 0.5">   
            <div class="imgholder"> 
               <div class="column">
                   <img src="img/rooms/pexels-photo-164595.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-271631.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-97083.jpeg" style="width:100%">
               </div>
               <div class="column">
                   <img src="img/rooms/pexels-photo-833045.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-1743229.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-276671.jpeg" style="width:100%">
               </div>  
               <div class="column">
                   <img src="img/rooms/pexels-photo-189293.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-189333.jpeg" style="width:100%">
                  <img src="img/rooms/pexels-photo-2119222.jpeg" style="width:100%">
               </div>
               <div class="column">
                   <img src="img/rooms/pexels-photo-210604.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-1571457.jpeg" style="width:100%">
                   <img src="img/rooms/pexels-photo-916337.jpeg" style="width:100%">
               </div>
             </div>
        </div>
    </section>
    ...
    <div class="row" style="margin-top: 580px" id="contacts">
            ...
            <div class="row bottomDiv2" id="my">
                <div class="col-md-5">
                    ...
                    <div style="margin-top: 25px">
                            ...
                            <br>
                             <input type="hidden" name="service" value="accommodation">
